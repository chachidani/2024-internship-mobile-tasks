class Urls{
  ...
  static const String autUrl = 'https://g5-flutter-learning-path-be.onrender.com/api/v2';
  static const String baseUrl2 = 'https://g5-flutter-learning-path-be.onrender.com/api/v2';
